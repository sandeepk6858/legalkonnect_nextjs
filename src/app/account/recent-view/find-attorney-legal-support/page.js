        ...
        <>
                        ...
                        <div className="flex items-center gap-x-9 overflow-x-auto" >
                            ...
                            <ul className="flex items-center gap-x-7">
                                ...
                                <li className=" py-5 border-b-2 border-orangeprimary cursor-pointer hover:opacity-[0.6]">
                                    <Link href="/account/favorites/qualified-attorney" className="text-orangeprimary  font-normal  whitespace-nowrap"> Find an Attorney </Link>
                                </li>
                                <li className=" py-5 border-b-0 border-blackcolor  cursor-pointer">
                                ...
                                <li className=" py-5 border-b-0 border-blackcolor cursor-pointer hover:opacity-[0.6] ">
                                    <Link href="/account/favorites/forum" className="font-normal text-blackcolor whitespace-nowrap "> Forums</Link>
                                </li>
                                <li className=" py-5 border-b-0 border-blackcolor cursor-pointer hover:opacity-[0.6] ">
            ...
            <div className="w-full ">
                <div className="xl:m-8 lg:m-4 md:m-4 m-3 flex flex-wrap justify-evenly gap-5">
                    <SupportCard showDivCount={false} />
                    <SupportCard showDivCount={false} />
                    <SupportCard showDivCount={false} />
                    <SupportCard showDivCount={false} />
                    <SupportCard showDivCount={false} />
...
export default AttorneylegalSupport;