        ...
        <div className="flex flex-col px-4 mt-[25px] mb-[25px]">
          <div className="flex w-full flex-col">
            <Tabs
              classNames={{
                tabList:
                  "gap-6 w-[280px] relative rounded-none py-4 border-divider",
            ...
            >
              ...
              >
                <Card>
                  <CardBody>
                    <div className="profile-picture-box profile-item-box px-[25px] border-b pb-[30px] border-#[F7F7F7]">
                      ...
                      >
                        {/* <input
                          ...
                          name="avatar"
                          accept="image/*"
                          className="file_input_dropzone settings"
                        /> */}
                        <div className="wrap_btn_dropzone">
                          <div className="settings_dropzone flex items-center">
                    ...
                    <div className="contact-info-box profile-item-box px-[25px] py-[25px] border-b border-[#F7F7F7]">
                      <h3 className="box-title font-semibold text-bluesecondary text-[16px]">
                        Contact Info
                      </h3>
                      <div className="flex flex-wrap gap-[14px] justify-between">
                        <div className="flex flex-col gap-2 pt-3 w-[calc(50%_-_10px)]">
                    ...
                    <div className="contact-info-box profile-item-box px-[25px] py-[25px]">
                      <div className="flex flex-col w-full">
              ...
              <Tab key="Billing Methods" title="Billing Methods">
                <Card>
                  <CardBody>
              ...
              <Tab key="Attorney Credentials" title="Attorney Credentials">
                <Card>
                  <CardBody>
                    Excepteur sint occaecat cupidatat non proident, sunt in
              ...
              <Tab key="Password & Security" title="Password & Security">
                <Card>
                  <CardBody>
                    Excepteur sint occaecat cupidatat non proident, sunt in
                    culpa qui officia deserunt mollit anim id est laborum.bnvng
                  </CardBody>
                </Card>
              </Tab>
            </Tabs>
