            ...
            <div className="w-full  mx-[auto]  max-w-[600px] lg:max-w-[300px] ">
                <div className=" w-full max-w-[600px] lg:max-w-[300px] border border-lightgrey shadow-xl rounded-md ">
                    <div className="border-b border-lightgrey">
                        <h3 className="text-base font-medium text-bluesecondary p-5 ">Request to Substitution</h3>
                    </div>
                    <div className="p-5">
                        <ul className="pointer text-sm text-center ">
                            <li className={`p-4 rounded-3xl  mb-2.5 ${ firstPage ? "bg-lightblue text-blueprimary" : " bg-lightgrey text-blackcolor"}`}>   
                                <button>Title & Description</button>
                            </li>
                            <li className={`p-4 rounded-3xl   mb-2.5 ${ secondPage ?"bg-lightblue text-blueprimary":"bg-lightgrey  text-blackcolor"}`}>
                                <button>Location & court </button>
                            </li>
                            <li className={`p-4 rounded-3xl  mb-2.5 ${ thirdPage ? "bg-lightblue text-blueprimary":"bg-lightgrey  text-blackcolor"}`}>
                                <button>Preferred Qualifications</button>
                            </li>
                            <li className={`p-4 rounded-3xl  mb-2.5 ${ forthPage ? "bg-lightblue text-blueprimary":"bg-lightgrey  text-blackcolor"}`}>
                ...
                <div className="w-full max-w-[600px] m-[auto] mt-4 lg:mt-0 lg:max-w-[900px] border border-lightgrey shadow-xl rounded-md box-border">
                    ...
                    <div className=" w-full px-7 pt-7 pb-7 border-b border-lightgrey    ">
                        <div className="text-base font-semibold w-full	">
                            <h3 className="mb-2.5">Add Specialization <span className ="text-bluesecondary">*</span>
                            </h3>
