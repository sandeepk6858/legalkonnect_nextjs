...
const Home = () => {
  ...
  <div className="container px-5 pt-[60px] md:pt-[80px] mx-auto flex flex-wrap">
    ...
    <div className="md:p-4 sm:p-1 lg:w-1/3 md:w-full sm:mx-[15px] md:mx-[0]">
        <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 sm:p-4 p-8 sm:flex-row flex-col">
      ...
      <div className="p-4 lg:w-1/3 md:w-1/2 ">
        <div className="h-full text-center flex-col items-center flex justify-items-center shadow-md p-[30px] bg-[url('https://legalkonnect.com/storage/uploads/pages/a474d50e-b4cd-43ce-8bac-9ee3db5fa1d9.jpg')] bg-cover bg-no-repeat bg-center relative discenter">
          <div className="w-full overlay_card  items-center flex justify-items-center flex-col">
            <h2 className="text-[24px] leading-[35px] font-[600] mb-[10px] mt-[10px] text-[#fff] text-center px-[20px]">A LEGAL SERVICES MARKETPLACE FOR THE <br/> DIGITAL AGE</h2>
  ...
  <div className="flex flex-col text-center w-full mb-[40px]">
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 lg:w-1/2">
        <div className="h-full gap-[30px] sm:pb-[15px] md:pb[15] lg:pb-[0px] xl:pb[0] flex xl:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left shadow-lg">
