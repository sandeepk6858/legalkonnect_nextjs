        ...
        <>
            <div className="w_wid p-[20px] lf:p-[30px] w-1/1 md:w-1/3 lg:w-1/4 flex flex-col items-start bg-[#fff] shadow-lg rounded-[20px]">
                <div className="flex justify-between items-center w-[100%]">
                    <Link href={"/transcripts/" + data?.id} className="text-[20px] leading-[24px] font-font-medium cursor-pointer text-blackcolor">
                        {data?.title}
                    </Link>
                ...
                <div className="flex flex-col justify-start items-start text-blackcolor">
                    <p className="text-[14px] mb-[7px] leading-[20px]">
                        Offer: <span className="font-medium text-blackcolor">{data?.offer}</span>
                    </p>
                    <p className="text-[14px] mb-[7px] leading-[20px]">
                        Document Type:{" "}
                        <span className="font-medium text-blackcolor">{data?.doc_type}</span>
                    </p>
                    <p className="text-[14px] mb-[7px] leading-[20px]">
                        Country:{" "}
                    ...
                    <p className="text-[14px] mb-[7px] leading-[20px]">
                        State:{" "}
                        <span className="font-medium text-blackcolor">{data?.state}</span>
                    </p>
                    <p className="text-[14px] mb-[7px] leading-[20px]">
                        County:{" "}
                        <span className="font-medium text-blackcolor">
                ...
                <div className="flex justify-between items-center w-full mt-[30px]">
                    <div className="inline-flex items-center">
                        <img
                            ...
                            src={data?.user?.avatar[0]?.url ? data?.user.avatar[0].url : imageURL("no_avatar.jpg")}
                        />
                        <span className="flex-grow flex flex-col pl-4">
                            <span className="title-font font-medium text-black">
                                <Link href={"/users/profile/" + data?.user?.id} className="text-black">
