...
const MakeBidPopUp = () => {
    ...
    return (
        <div>
            ...
            {openModal && (
                <div className="fixed z-[1] top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex justify-center items-center overflow-auto py-[100px]" >
...
<h2 className='text-[20px] font-semibold border-b-2 '>Terms :</h2>
